...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ein speed-type pdf-tools rainbow-delimiters emacs-everywhere rainbow-mode auctex ivy-prescient typescript-mode webkit move-dup glsl-mode telephone-line multiple-cursors mindre-theme magit ivy-rich helpful counsel)))
(custom-set-faces
