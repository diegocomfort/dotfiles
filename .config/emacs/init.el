...
(custom-set-variables
 ...
 '(package-selected-packages
   '(rainbow-mode auctex fish-mode ivy-prescient typescript-mode webkit move-dup glsl-mode telephone-line multiple-cursors mindre-theme magit ivy-rich helpful counsel)))
(custom-set-faces
